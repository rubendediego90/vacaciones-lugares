...
<div class="audio-player">
  ...
  <div class="controls">
    <button class="player-button" ref="playerButton">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#3D3132">
  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clip-rule="evenodd" />
</svg>
    </button>
    <input type="range" class="timeline" ref="timeline" max="100" value="0">
    <button class="sound-button" ref="soundButton">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#3D3132">
...
function toggleSound () {
  audio.va.lue.muted = !audio.value.muted;
  soundButton.value.innerHTML = audio.value.muted ? muteIcon : soundIcon;
}

onMounted(()=>{
  audio.value = document.querySelector('audio'),
  soundButton.value = document.querySelector('.sound-button'),
  soundButton.value.addEventListener('click', toggleSound);
